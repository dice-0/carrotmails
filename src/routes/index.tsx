...
export const Route = createFileRoute("/")({
  ...
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Personalized, opt-in email from your own Gmail. One-click unsubscribe, reply detection, suppression, and consent tracking built in. Permission-based only. From $3.50/mo." },
      { name: "keywords", content: "opt-in email, permission-based email, newsletter, customer email, CRM email, Gmail sender, mail merge, list unsubscribe" },
      { property: "og:title", content: "Carrot Mails: consent-based email from your own inbox" },
      { property: "og:description", content: "Personalized, opt-in email from your own Gmail. One-click unsubscribe and consent tracking built in." },
      ...
      { name: "twitter:title", content: "Carrot Mails: consent-based email from your own inbox" },
      { name: "twitter:description", content: "Personalized, opt-in email from your own Gmail. Consent tracking and one-click unsubscribe built in." },
    ...
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          description: "Consent-based email marketing software. Send personalized opt-in email from your own Gmail with one-click unsubscribe and consent tracking built in.",
          offers: [
            { "@type": "Offer", name: "Premium", price: "3.50", priceCurrency: "USD", url: "https://carrotmails.work/", description: "5,000 opt-in sends per month" },
            { "@type": "Offer", name: "Lifetime", price: "49.50", priceCurrency: "USD", url: "https://carrotmails.work/", description: "One-time payment, unlimited sending, first 100 buyers" },
          ],
      ...
      },
      {
        ...
        children: JSON.stringify({
          ...
          "@type": "FAQPage",
          mainEntity: [
            { "@type": "Question", name: "What is Carrot Mails?", acceptedAnswer: { "@type": "Answer", text: "Carrot Mails is a permission-based email tool. It sends personalized, opt-in email from your own Gmail inbox to contacts who have explicitly agreed to receive email from you, with one-click unsubscribe and consent tracking built in." } },
            { "@type": "Question", name: "How much does Carrot Mails cost?", acceptedAnswer: { "@type": "Answer", text: "The Premium plan is $3.50 per month and includes 5,000 opt-in sends. Lifetime access with unlimited sending is a one-time $49.50 payment, limited to the first 100 buyers." } },
            { "@type": "Question", name: "Can I use Carrot Mails for cold outreach?", acceptedAnswer: { "@type": "Answer", text: "No. Carrot Mails is permission-based only. Every recipient must have explicitly opted in to receive email from you. Cold outreach and unsolicited email are not allowed." } },
            { "@type": "Question", name: "Does Carrot Mails handle replies and unsubscribes?", acceptedAnswer: { "@type": "Answer", text: "Yes. Every email includes a one-click unsubscribe header (RFC 8058). Replies are detected automatically and future sends to that recipient pause. Bounces and unsubscribes flow into a global suppression list." } },
            { "@type": "Question", name: "Do I need my own domain?", acceptedAnswer: { "@type": "Answer", text: "No. You connect your existing Gmail account and Carrot Mails sends from your real address. For best deliverability, add SPF, DKIM, and DMARC records to your domain." } },
          ],
        }),
      },
    ],
