...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Carrot Mails - bulk email, delivered fresh" },
      { name: "description", content: "Send personalized bulk emails from your own Gmail or Outlook. Fresh, fast, friendly." },
