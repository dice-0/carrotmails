        ...
        children: JSON.stringify({
          ...
          "@graph": [
            ...
            },
            {
              ...
              operatingSystem: "Web",
              description: "Send personalized bulk emails from your own Gmail or Outlook with reply detection, suppression lists, embeddable forms, and campaigns.",
              offers: [
                { "@type": "Offer", name: "Pro", price: "3.50", priceCurrency: "USD", description: "5,000 sends per month" },
